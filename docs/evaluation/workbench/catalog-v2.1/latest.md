...
| `release_products` | `data/products/fairprice-v2-snapshot.json` | `ff6781288569731e...` |
...
|---|---:|---:|---:|
| Scenario expectation rate | 0.95 | 0.95 | 0.0 |
| Mean distinct recipes | 1.0 | 6.7368 | 5.7368 |
| Consecutive repetitions | 228 | 6 | -222 |
| Failure cases | 38 | 2 | -36 |
...
|---|---:|---:|---:|
| Scenario expectation rate | 0.95 | 0.95 | 0.0 |
| Mean distinct recipes | 1.9737 | 6.7368 | 4.7631 |
...
| 37 | heldout-greedy-baseline | hold-037 | feasibility_mismatch |
| 38 | heldout-greedy-baseline | hold-039 | feasibility_mismatch |
| 39 | heldout-rule-only-baseline | hold-037 | feasibility_mismatch |
| 40 | heldout-rule-only-baseline | hold-039 | feasibility_mismatch |
| 41 | heldout-mealcraft-planner | hold-037 | feasibility_mismatch |
| 42 | heldout-mealcraft-planner | hold-039 | feasibility_mismatch |
| 43 | agent-benchmark | agent-005 | extraction_mismatch, clarification_mismatch |
| 44 | agent-benchmark | agent-016 | extraction_mismatch, clarification_mismatch |
| 45 | agent-benchmark | agent-017 | extraction_mismatch |
| 46 | agent-benchmark | agent-018 | extraction_mismatch |
| 47 | agent-benchmark | agent-019 | extraction_mismatch |
| 48 | agent-benchmark | agent-024 | extraction_mismatch, clarification_mismatch |
