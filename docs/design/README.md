...
| Planning and deterministic validation | [Planning Engine](planning-engine.md), [Algorithm Engineering Handoff](algorithm-engineering-handoff.md) and [Input Diagnostics](planning-input-diagnostics.md) | Final-scope problem/solution contract, feasible plan, trace, conflict result and derived Shopping List |
