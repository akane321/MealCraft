...
| Planning and deterministic validation | [Planning Engine](planning-engine.md), [Algorithm Engineering Handoff](algorithm-engineering-handoff.md), [Input Diagnostics](planning-input-diagnostics.md) and [Offline Repair and Relaxation](planning-offline-extensions.md) | Final-scope problem/solution contract, feasible plan, trace, conflict result and derived Shopping List |
