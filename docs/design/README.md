...
| --- | --- | --- |
| Recipe and ingredient knowledge | [Recipe and Ingredient Data](recipe-ingredient-data.md), [Data Engineering Handoff](../data/README.md) and [Ingredient Hierarchy](ingredient-hierarchy.md) | Validated recipes, canonical ingredients, nutrition, provenance, release manifest, and what each ingredient belongs to for exclusions |
...
| Planning and deterministic validation | [Planning Engine](planning-engine.md), [Algorithm Engineering Handoff](algorithm-engineering-handoff.md), [Input Diagnostics](planning-input-diagnostics.md) and [Offline Repair and Relaxation](planning-offline-extensions.md); offline components: [Integration Guide](planning-integration-guide.md), [Constraint Compiler](planning-constraint-compiler.md), [Beam Search](planning-beam-search.md), [Exhaustive Oracle](planning-exhaustive-oracle.md), [Preview](planning-preview.md), [Mixed Shopping](planning-mixed-shopping.md), [Recipe Input](planning-recipe-input.md), [Product Input](planning-product-input.md) | Final-scope problem/solution contract, feasible plan, trace, conflict result and derived Shopping List |
...
| Planning and validation in the product path | [Planning and Validation v2](planning-validation-v2.md) | Wiring the engine into the product: validator verdicts, explained infeasibility, variety caps and ingredient overlap, nutrition scope, whole-slot-set purchasing, minimal-perturbation replanning, and the controlled parameters |
