...
2. Import release v2 into the runtime catalog. Enrichment (with part C
   re-enriched), merge, build, attribution, quality report and the sampled audit
   are all done. Every catalog-dependent measurement in this document waits on
   the import.
