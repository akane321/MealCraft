...
conditions (priority 3). Every other episode's shopping list is complete; the
...
2. Record the owner's sampled audit of the AI completeness review of release
   v2.1 (ADR-0024 section 2 admits AI enrichment on that condition).
3. Author evaluation conditions for the larger catalog: two infeasible
