...
2. Make the imported release v2 recipes reachable from recommendations and
   planning (candidate retrieval currently reads the first 500 recipes by id),
   then re-run the catalog-dependent measurements in this document against the
   larger catalog.
